 ...
 */
module.exports = function(dpkg, rlinks, emitter){
  ...
  var values_data = Object.keys(resources.filter(function(x){return x.name ==='values';})[0].data);
  ...
  var covariance_data = Object.keys(resources.filter(function(x){return x.name ==='covariance';})[0].data);  
