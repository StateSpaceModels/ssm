...
class TestCcoder(unittest.TestCase):
    ...
    def setUp(self):
        ...
        model = json.load(open(os.path.join('..' ,'noise', 'model', 'datapackage.json')))
        model["resources"][1]["data"][2]["white_noise"] = {}
        model["resources"][1]["data"][3]["white_noise"] = {}
        ...
        print model["resources"][1]["data"][4]["white_noise"]
        ...
        model = json.load(open(os.path.join('..' ,'diff', 'model', 'datapackage.json')))
        model["resources"][1]["data"][10] = {"from": "R_paris",   "to": "I_paris",   "rate": "correct_rate(v)",            "description":"testing"}
        model["resources"][1]["data"][11] = {"from": "R_nyc",   "to": "I_nyc",   "rate": "correct_rate(v)",                "description":"testing"}
        print model["resources"][1]["data"][11]
