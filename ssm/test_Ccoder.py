...
class TestCcoder(unittest.TestCase):
    ...
    def test_eval_Q(self):
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][0][4],'((1)*'+term_nyc+'*(1)')
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][1][4],'((1)*'+term_paris+'*(1)')
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][2][4],'((-1)*'+term_nyc+'*(1)')
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][3][4],'((-1)*'+term_paris+'*(1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][3][5],0)
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][0],'((1)*'+term_nyc+'*(1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][1],'((1)*'+term_paris+'*(1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][2],'((1)*'+term_nyc+'*(-1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][3],'((1)*'+term_paris+'*(-1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][4],'((1)*'+term_nyc+'*(1) + ((1)*'+term_paris+'*(1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][5],'((1)*'+term_nyc+'*(1)')
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][5][4],'((1)*'+term_nyc+'*(1)')
        ...
        self.assertEqual(calc_Q["no_env_sto"]["Q_cm"][0][4],'((1)*'+term2_n+'*(1)')
        ...
        self.assertEqual(calc_Q["no_env_sto"]["Q_cm"][1][4],'((1)*'+term2_p+'*(1)')
        ...
        self.assertEqual(calc_Q["no_env_sto"]["Q_cm"][2][4],'((-1)*'+term2_n+'*(1)')
        ...
        self.assertEqual(calc_Q["no_env_sto"]["Q_cm"][3][4],'((-1)*'+term2_p+'*(1)')
        self.assertEqual(calc_Q["no_env_sto"]["Q_cm"][3][5],0)
        self.assertEqual(calc_Q["no_env_sto"]["Q_cm"][4][0],'((1)*'+term2_n+'*(1)')
        self.assertEqual(calc_Q["no_env_sto"]["Q_cm"][4][1],'((1)*'+term2_p+'*(1)')
        self.assertEqual(calc_Q["no_env_sto"]["Q_cm"][4][2],'((1)*'+term2_n+'*(-1)')
        self.assertEqual(calc_Q["no_env_sto"]["Q_cm"][4][3],'((1)*'+term2_p+'*(-1)')
        self.assertEqual(calc_Q["no_env_sto"]["Q_cm"][4][4],'((1)*'+term2_n+'*(1) + ((1)*'+term2_p+'*(1)')
        self.assertEqual(calc_Q["no_env_sto"]["Q_cm"][4][5],'((1)*'+term2_n+'*(1)')
        ...
        self.assertEqual(calc_Q["no_env_sto"]["Q_cm"][5][4],'((1)*'+term2_n+'*(1)')
    ...
    def test_eval_Q_tricky_cases(self):
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][0][3],0)
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][0][4],'((1)*(('+term1_n+'*((sto)**2))*'+term1_n+') + (-1)*(('+term2_n+'*((sto)**2))*'+term1_n+'))*(1)')
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][1][4],'((1)*(('+term1_p+'*((sto)**2))*'+term1_p+') + (-1)*(('+term2_p+'*((sto)**2))*'+term1_p+'))*(1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][1][5],0)
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][2][3],0)
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][2][4],'((-1)*(('+term1_n+'*((sto)**2))*'+term1_n+'))*(1)')
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][3][4],'((-1)*(('+term1_p+'*((sto)**2))*'+term1_p+'))*(1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][3][5],0)
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][0],'((1)*(('+term1_n+'*((sto)**2))*'+term1_n+'))*(1) + ((1)*(('+term1_n+'*((sto)**2))*'+term2_n+'))*(-1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][1],'((1)*(('+term1_p+'*((sto)**2))*'+term1_p+'))*(1) + ((1)*(('+term1_p+'*((sto)**2))*'+term2_p+'))*(-1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][2],'((1)*(('+term1_n+'*((sto)**2))*'+term1_n+'))*(-1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][3],'((1)*(('+term1_p+'*((sto)**2))*'+term1_p+'))*(-1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][4],'((1)*(('+term1_n+'*((sto)**2))*'+term1_n+'))*(1) + ((1)*(('+term1_p+'*((sto)**2))*'+term1_p+'))*(1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][5],'((1)*(('+term1_n+'*((sto)**2))*'+term1_n+'))*(1)')
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][5][3],0)
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][5][4],'((1)*(('+term1_n+'*((sto)**2))*'+term1_n+'))*(1)')
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][0][3],0)
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][0][4],'((1)*(('+term1_n+'*((sto)**2))*'+term1_n+'))*(1)')
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][1][4],'((1)*(('+term1_p+'*((sto)**2))*'+term1_p+'))*(1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][1][5],0)
        ...
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][3][4],'((-1)*(('+term1_p+'*((sto)**2))*'+term1_p+'))*(1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][3][5],0)
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][0],'((1)*(('+term1_n+'*((sto)**2))*'+term1_n+'))*(1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][1],'((1)*(('+term1_p+'*((sto)**2))*'+term1_p+'))*(1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][2],'((1)*(('+term1_n+'*((sto)**2))*'+term1_n+'))*(-1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][3],'((1)*(('+term1_p+'*((sto)**2))*'+term1_p+'))*(-1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][4],'((1)*(('+term1_n+'*((sto)**2))*'+term1_n+'))*(1) + ((1)*(('+term1_p+'*((sto)**2))*'+term1_p+'))*(1)')
        self.assertEqual(calc_Q["no_dem_sto"]["Q_cm"][4][5],'((1)*(('+term1_n+'*((sto)**2))*'+term1_n+'))*(1)')
